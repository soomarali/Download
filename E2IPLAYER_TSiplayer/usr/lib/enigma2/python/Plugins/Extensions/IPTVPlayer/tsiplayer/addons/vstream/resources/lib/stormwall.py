import re
import os
from Plugins.Extensions.IPTVPlayer.tsiplayer.libs.xbmc import xbmcaddon
import time

from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.comaddon import VSlog, dialog, VSPath, xbmc
