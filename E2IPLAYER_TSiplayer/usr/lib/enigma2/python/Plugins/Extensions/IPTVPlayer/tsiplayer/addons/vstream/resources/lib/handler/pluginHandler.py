...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.comaddon import addon, VSlog, VSPath, siteManager
...
class cPluginHandler:
    ...
    def __importPlugin(self, sName, sLabel=""):
        try:
            exec("from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.sites import " + sName, globals())
