...
# Venom.
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.comaddon import dialog, isMatrix
...
class cePg:
    ...
    def TextBoxes(self, heading, anounce):
        from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.comaddon import window, xbmc
