...
# Venom.
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.gui.gui import cGui
...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.comaddon import dialog, addon, VSlog
...
class cHosterGui:
    ...
    def getHoster(self, sHosterFileName):
        mod = __import__('Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.hosters.' + sHosterFileName, fromlist=['cHoster'])
        ...
        try:
            ...
            if aLink and (aLink[0] or aLink[1]):  # Le hoster ne sait pas résoudre mais a retourné une autre url
                ...
                if aLink[0]:
                    ...
                    from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.player import cPlayer
                    oPlayer = cPlayer()
