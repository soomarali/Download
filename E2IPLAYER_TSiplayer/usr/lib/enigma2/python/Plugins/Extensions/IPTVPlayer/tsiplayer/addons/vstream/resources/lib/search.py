...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.handler.rechercheHandler import cRechercheHandler
...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.comaddon import progress, VSlog, addon, window
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.util import Quote
...
class cSearch:
    ...
    def searchGlobal(self, sSearchText = '', sCat = ''):
        try:
            ...
            VSlog('sSearchText: ' + str(sSearchText))
