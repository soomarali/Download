...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.comaddon import addon, VSlog, VSPath, siteManager
...
class cPluginHandler:
    ...
    def __importPlugin(self, sName, sLabel=""):
        try:
            exec("from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.sites import " + sName, globals())
    ...
    def getAvailablePlugins(self, sLabel="", force=False):
        ...
        for sFileName in aFileNames:
            if not sitesManager.isEnable(sFileName):    # Site dsactiv par la team
                continue
