...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.handler.rechercheHandler import cRechercheHandler
...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.comaddon import progress, VSlog, addon, window
