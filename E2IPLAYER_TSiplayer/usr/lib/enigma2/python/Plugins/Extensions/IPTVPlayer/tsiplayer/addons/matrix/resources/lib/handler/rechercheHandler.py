...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.comaddon import addon, VSlog, siteManager
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.db import cDb

import sys
from Plugins.Extensions.IPTVPlayer.tsiplayer.lib.xbmc import xbmcvfs
...
class cRechercheHandler:
    ...
    def importPlugin(self, sName, sCat):
        ...
        try:
            plugin = __import__('Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.sites.%s' % sName, fromlist=[sName])
