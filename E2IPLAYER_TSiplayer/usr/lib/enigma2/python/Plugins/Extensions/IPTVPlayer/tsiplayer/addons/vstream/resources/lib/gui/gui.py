...
from Plugins.Extensions.IPTVPlayer.tsiplayer.libs.xbmc import xbmcplugin
...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.comaddon import listitem, addon, dialog, window, isKrypton, isNexus, progress, VSlog
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.gui.contextElement import cContextElement
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.gui.guiElement import cGuiElement
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.handler.inputParameterHandler import cInputParameterHandler
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.handler.outputParameterHandler import cOutputParameterHandler
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.handler.pluginHandler import cPluginHandler
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.parser import cParser
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.util import QuotePlus
...
class cGui:
    ...
    def addNewDir(self, Type, sId, sFunction, sLabel, sIcon, sThumbnail='', sDesc='', oOutputParameterHandler='', sMeta=0, sCat=None):
        ...
        printDBG('_getTmdbId00:------------------>'+str(oGuiElement.getTmdbId()))
        ...
        printDBG('_getTmdbId001:------------------>'+str(oGuiElement.getTmdbId()))
    ...
    def addFolder(self, oGuiElement, oOutputParameterHandler='', _isFolder=True):
        ...
        if oOutputParameterHandler.getValue('sId') == 'cHosterGui':
            oGuiElement.setMeta(0)
            printDBG('_addHost')
        printDBG('_addFolder')
 ...
 #affiche tag HD
        ...
        self.TsiplayerWrite(oGuiElement,oListItem, oOutputParameterHandler)
        # Vider les paramètres pour être recyclé
        oOutputParameterHandler.clearParameter()
        return oListItem

    def TsiplayerWrite(self,oGuiElement,oListItem, oOutputParameterHandler):
        oListItem.setProperty('sFileName',oGuiElement.getFileName())
        oListItem.setProperty('sParams',oOutputParameterHandler.getParameterAsUri())
        oListItem.setProperty('sHosterIdentifier',oOutputParameterHandler.getValue('sHosterIdentifier')) 
        oListItem.setProperty('sMediaUrl',oOutputParameterHandler.getValue('sMediaUrl'))  
        return ''
    ...
    def _createListItem(self, oGuiElement, oListItem = None):
        ...
        printDBG('TsiplayerWrite oListItem sss------------------>:'+itemTitle+' :'+str(oListItem.getItems()))
        return oListItem
    ...
    def getSearchResult(self):
        VSlog('cGui.searchResults:'+str(cGui.searchResults))
