...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.comaddon import addon, VSlog, siteManager
...
class cRechercheHandler:
    ...
    def importPlugin(self, sName, sCat):
        ...
        try:
            plugin = __import__('Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.sites.%s' % sName, fromlist=[sName])
