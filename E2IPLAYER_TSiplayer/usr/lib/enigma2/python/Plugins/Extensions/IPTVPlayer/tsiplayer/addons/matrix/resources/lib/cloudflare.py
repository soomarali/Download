...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib.util import urlEncode
...
class CloudflareBypass(object):
    ...
    def GetHtml(self, url, htmlcontent='', cookies='', postdata=None, Gived_headers=''):
        ...
        from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.matrix.resources.lib import cloudscrape
