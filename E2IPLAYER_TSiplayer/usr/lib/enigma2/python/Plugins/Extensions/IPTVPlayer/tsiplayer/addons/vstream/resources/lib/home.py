...
from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.comaddon import addon, window
...
class cHome:
    ...
    def showHistory(self):
        ...
        from Plugins.Extensions.IPTVPlayer.tsiplayer.addons.vstream.resources.lib.db import cDb
        with cDb() as db:
            row = db.get_history()
